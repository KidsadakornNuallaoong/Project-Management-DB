...
-- Select all data from Requirement table
SELECT * FROM Requirement;

-- Select all data from Project table
SELECT * FROM Project;

-- Select all data from Task table
SELECT * FROM Task;

-- Select all data from Company table
SELECT * FROM Company;
...
SELECT *
FROM COMPANY C 
INNER JOIN DEPARTMENT D ON D.CID = C.CID
INNER JOIN EMPLOYEE E ON E.DID = D.DID
INNER JOIN TASK T ON T.EID = E.EID
ORDER BY C.CID;